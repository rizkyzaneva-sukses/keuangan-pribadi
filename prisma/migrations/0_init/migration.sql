...
-- CreateEnum
CREATE TYPE "JenisUtangPiutang" AS ENUM ('UTANG', 'PIUTANG');

-- CreateEnum
CREATE TYPE "StatusUtangPiutang" AS ENUM ('BELUM', 'SEBAGIAN', 'LUNAS');
...
CREATE TABLE "UtangPiutang" (
    "id" SERIAL NOT NULL,
    "userId" INTEGER NOT NULL,
    "jenis" "JenisUtangPiutang" NOT NULL,
    "status" "StatusUtangPiutang" NOT NULL DEFAULT 'BELUM',
    "namaPihak" TEXT NOT NULL,
    "tanggal" TIMESTAMP(3) NOT NULL,
    ...
    CONSTRAINT "UtangPiutang_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "PembayaranUtangPiutang" (
    "id" SERIAL NOT NULL,
    "utangPiutangId" INTEGER NOT NULL,
    "userId" INTEGER NOT NULL,
    "tanggal" TIMESTAMP(3) NOT NULL,
    "jumlah" INTEGER NOT NULL,
    "keterangan" TEXT,
    ...
    CONSTRAINT "PembayaranUtangPiutang_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "UtangPiutang_userId_jenis_status_idx" ON "UtangPiutang"("userId", "jenis", "status");

-- CreateIndex
CREATE INDEX "UtangPiutang_userId_tanggal_idx" ON "UtangPiutang"("userId", "tanggal");

-- CreateIndex
CREATE INDEX "PembayaranUtangPiutang_utangPiutangId_idx" ON "PembayaranUtangPiutang"("utangPiutangId");

-- CreateIndex
CREATE INDEX "PembayaranUtangPiutang_userId_tanggal_idx" ON "PembayaranUtangPiutang"("userId", "tanggal");
...
-- AddForeignKey
ALTER TABLE "UtangPiutang" ADD CONSTRAINT "UtangPiutang_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PembayaranUtangPiutang" ADD CONSTRAINT "PembayaranUtangPiutang_utangPiutangId_fkey" FOREIGN KEY ("utangPiutangId") REFERENCES "UtangPiutang"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PembayaranUtangPiutang" ADD CONSTRAINT "PembayaranUtangPiutang_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
